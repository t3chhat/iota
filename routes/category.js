...
router.get('/:recordid/show', function(req, res, next) {
    let query = "SELECT id, category_name FROM category WHERE id = ?";
...
router.post('/save', function(req, res, next) {
    let updatequery = "UPDATE category SET category_name = ? WHERE id = ?";

    db.query(updatequery,[req.body.category_name, req.body.id],(err, result) => {
