...
let query = "SELECT id, first_name, middle_name, last_name, email_address, phone_number, address_line1, address_line2, city, state, zip_code, country, payment_method FROM customer";
