...
router.get('/:recordid/show', function(req, res, next) {
    let query = "SELECT id, user_id, order_date, total_amount, order_status FROM order_detail WHERE id = ?";
...
router.post('/save', function(req, res, next) {
    let updatequery = "UPDATE order_detail SET user_id = ?, order_date = ?, total_amount = ?, order_status = ? WHERE id = ?";

    db.query(updatequery,[req.body.user_id, req.body.order_date, req.body.total_amount, req.body.order_status, req.body.id],(err, result) => {
...
router.get('/:recordid/delete', function(req, res, next) {
    let query = "DELETE FROM order_detail WHERE id = ?";
