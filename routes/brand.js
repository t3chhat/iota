...
router.get('/:recordid/show', function(req, res, next) {
    let query = "SELECT id, brand_name FROM brand WHERE id = ?";
...
router.post('/save', function(req, res, next) {
    let updatequery = "UPDATE brand SET brand_name = ? WHERE id = ?";

    db.query(updatequery,[req.body.brand_name, req.body.id],(err, result) => {
...
router.get('/:recordid/delete', function(req, res, next) {
    let query = "DELETE FROM brand WHERE id = ?";
